...
function boxClicked(element) {
    ...
    if (playerSign == 'X')
        element.setAttribute('style', 'background-color: #dc685a; color: #fff');
    else
        element.setAttribute('style', 'background-color: #ecaf4f; color: #fff');
...
function compTurn() {
    ...
    /* Change background color of selected box */
    if (playerSign == 'O')
        compSelect.setAttribute('style', 'background-color: #dc685a; color: #fff');
    else
        compSelect.setAttribute('style', 'background-color: #ecaf4f; color: #fff');
