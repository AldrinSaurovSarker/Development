class colorOrderGame {
    ...
    gameover(res, id=null) {
        if (res == 'victory') {
            ...
            // GREEN border to the box which was needed to be clicked
            if (this.#currentStage == 1)
                document.getElementById(this.height * this.width - this.#playerClicks - 1).style.border = '5px solid #0f0';
            else
                document.getElementById(this.#playerClicks).style.border = '5px solid #0f0';
    ...
    showInstruction(status='playing') {
        ...
        if (status == 'victory') {
            ...
            instructionMessage.innerHTML = 'You have patience!';
            ...
            instructionMessage.innerHTML = 'You should choose in correct order';
            continueBtn.style.display = 'none';
            gameoverBtn.style.display = 'flex';
