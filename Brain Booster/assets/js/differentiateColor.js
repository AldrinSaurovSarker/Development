class differentiateColorGame {
    /* let arr is any inside values.
    * The 1st index of arr means the color which will be allover the board
    * The 2nd index of arr means the color which has to be found */
    #values = [
        [['#800000', '#a52a2a'], ['#111111', '#222222']],
        [['#441166', '#600080'], ['#00ff00', '#00cc00']],
        [['#ff69b4', '#d87093']],
        [['#afce00', '#bfde11'], ['#123456', '#1e3456']],
        [['#770000', '#7f0909']],
    ]
    ...
    /* Constructor */
    constructor(width=5, height=6, gridLength='90px', gridGap='5px', timeOut=10000, totalStage=5) {
        ...
        this.totalStage = totalStage; // Number of stages
    ...
    randomizeBoard() {
        // randomValue: which set of colors should be shown
        // randomPosition: Where the imposter color will be situated
    ...
    putValues() {
        // introduction box
        document.querySelector('.introduction').innerHTML = "Find and click the different color";
        ...
        for (let i=0; i<this.width * this.height; i++) {
            ...
            if (i == this.#randomPosition) {
                square.style.backgroundColor = this.#values[this.#currentStage-1][this.#randomValue][1];
            }
            else
                square.style.backgroundColor = this.#values[this.#currentStage-1][this.#randomValue][0];
        }
    }
    ...
    gameover(res, id=null) {
        ...
        if (res == 'victory') {
            ...
            document.getElementById(this.#randomPosition).style.border = '5px solid #0f0';

            // Red border at the wrong clicked square
            if (id != null) {
                document.getElementById(id).style.border = '5px solid #dc3545';
    ...
    updatePlayerProgress() {
        ...
        if (playerLevel == '3') {
            localStorage.setItem('playerLevel', 4);
        }
    }
    ...
    showInstruction(status='playing') {
        ...
        if (status == 'victory') {
            ...
            instructionMessage.innerHTML = 'You have amazing eye-sight!';
            ...
            instructionMessage.innerHTML = 'Observe more carefully';
            continueBtn.style.display = 'none';
            gameoverBtn.style.display = 'flex';
            ...
            if (this.#currentStage != this.totalStage)
                ...
                headings.innerHTML = "This is the HARDEST round";

            if (this.#currentStage == 1)
                instructionMessage.innerHTML = "Find and click the different color";
            else
