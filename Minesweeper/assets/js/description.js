...
function setThemeProperties() {
    if (document.body.classList.contains('theme-light')) {
        ...
        bombType = '<i class="las la-radiation"></i>';
        bombColor = '#ffff00';
    }
        ...
        digitColors =  ['whitesmoke', 'whitesmoke', 'whitesmoke', 'whitesmoke', 'whitesmoke', 'whitesmoke', 'whitesmoke', 'whitesmoke'];
        bombType = '<i class="fas fa-snowflake"></i>';
        bombColor = '#c6fbff';
    }
...
function restartCurrentLevel() {
    ...
    for (let i = 0; i < ROW; i++) {
        for (let j = 0; j < COL; j++) {
            ...
            squares[i][j].draw.classList.remove('revealed', 'bombed', 'bomb');
